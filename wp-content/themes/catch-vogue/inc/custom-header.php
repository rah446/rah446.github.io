...
if ( ! function_exists( 'catch_vogue_has_header_media_text' ) ):
	...
	function catch_vogue_has_header_media_text() {
		...
		if ( ( is_front_page() && ! $header_media_title && ! $header_media_logo && ! $header_media_subtitle && ! $header_media_text && ! $header_media_url && ! $header_media_url_text ) || ( ( is_singular() || is_archive() || is_search() || is_404() ) && ! $header_image ) || ( 'homepage' === $enable && is_home() ) ) {
