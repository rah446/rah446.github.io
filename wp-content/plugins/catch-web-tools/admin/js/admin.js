...
jQuery(document).ready(function($){
	    ...
	    change: function(event, ui){
	    	...
	    	if( !( 'hover' == icon_brand_color || 'hover-static' == icon_brand_color ) ) {
		    	$(".genericon").hover(function(){
			        ...
			        $(this).css("color", $("#catchwebtools_social_color").val() );
			    });
		    }
	    },
	};
	...
	$('#catchwebtools_social_hover_color').wpColorPicker( options_social_hover_color );
    ...
    $(document).ready(function() {
        $('.catchp-sidebar-spot .sidebar-spot-inner, .col-2 .catchp-lists li, .col-3 .catchp-lists li, .catch-modules').matchHeight();
    });
});
...
(function( $ ) {
	...
	jQuery(document).ready(function($){
		...
		$('.catchwebtools_to_top_options_icon_bg_color').wpColorPicker( myOptions2 );

		$('#catchwebtools_to_top_options_border_radius').change(function(){
			$(".dashicon_to_top_admin").css({
						'-webkit-border-radius'	: $('#catchwebtools_to_top_options_border_radius').val() + '%',
					    '-moz-border-radius'	: $('#catchwebtools_to_top_options_border_radius').val() + '%',
					    'border-radius'			: $('#catchwebtools_to_top_options_border_radius').val() + '%',
					});
		});

		$('#catchwebtools_to_top_options_icon_size').change(function(){
			$(".dashicon_to_top_admin").css({
						'font-size'	: $('#catchwebtools_to_top_options_icon_size').val() + 'px',
		...
		$(".dashicon_to_top_admin").css({
			...
			'background-color' 		: $('.catchwebtools_to_top_options_icon_bg_color').val(),
			'font-size'				: $('#catchwebtools_to_top_options_icon_size').val() + 'px',
		    'height'				: $('#catchwebtools_to_top_options_icon_size').val() + 'px',
			'width'					: $('#catchwebtools_to_top_options_icon_size').val() + 'px',
		});
