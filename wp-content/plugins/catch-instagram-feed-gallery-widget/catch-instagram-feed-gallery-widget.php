...
define( 'CATCH_INSTGRAM_FEED_GALLERY_VERSION', '1.9' );
...
/**
 * Returns an array of image size registered for Social Gallery and Widget.
 *
 * @since Social Gallery and Widget 1.0.0
 */
