...
class Catch_Instagram_Feed_Gallery_Widget_Widget extends WP_Widget {
	...
	function __construct() {
		$this->defaults = array(
			'title'     => esc_html__( 'Social Gallery and Widget', 'catch-instagram-feed-gallery-widget' ),
			'type'      => 'users',
			'username'  => '',
			'number'    => 6,
			'padding'   => 0,
		...
		parent::__construct(
			...
			esc_html__( 'Social Gallery and Widget', 'catch-instagram-feed-gallery-widget' ), // Name.
			$widget_ops,
			$control_ops
		);
	}
