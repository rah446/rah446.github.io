...
<?php
	...
	//$catch_instagram_feed_gallery_widget_page_redirect = $catch_instagram_feed_gallery_widget_page;
?>
<div class="wrap">
	<h1 class="wp-heading-inline"><?php esc_html_e( 'Social Gallery and Widget', 'catch-instagram-feed-gallery-widget' ); ?></h1>
			...
			<div class="welcome-panel-content">
				<div class="welcome-panel-column-container">
					<div class="welcome-panel-column">
						<h3><img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../images/icon.svg' ); ?>" /><?php esc_html_e( 'Welcome to Social Gallery and Widget Settings', 'catch-instagram-feed-gallery-widget' ); ?></h3>

						<p><?php esc_html_e( 'Social Gallery and Widget Plugin adds the posts from your Social account that you want to showcase on your website.', 'catch-instagram-feed-gallery-widget' ); ?></p>

						<p><?php esc_html_e( 'You can add Social Feed as Gallery or Widget on your website. Simply either drag-and-drop the plugin in the widget area or you can add a shortcode from your WordPress dashboard if you want to place a copy of your Social feed directly onto your post/page.', 'catch-instagram-feed-gallery-widget' ); ?></p>
					</div>
				</div>
			</div>
		</div>
			...
			<form id="catch-instagram-feed-gallery-widget-main" method="post" action="options.php">
				...
				<div id="dashboard" class="wpcatchtab  nosave active">
					...
					<div id="public-usage" class="content-wrapper">
						<div class="header">
							<h3><?php esc_html_e( 'Add Social Feed as Gallery or Widget', 'catch-instagram-feed-gallery-widget' ); ?></h3>

						</div><!-- .header -->
						<div class="content">
							<div class="as-widget">
								<p><strong><?php esc_html_e( '1. Add using Widget via our Social Gallery Widget', 'catch-instagram-feed-gallery-widget' ); ?></strong></p>
				    ...
				    <div id="access-token" class="content-wrapper">
					    ...
					    <div class="content">
					    	<p class="info wp-ui-highlight"><span class="dashicons dashicons-info"></span> <?php esc_html_e( 'You can show social feed from any Private social accounts by providing the Access Token. This section allows you to set API parameters.', 'catch-instagram-feed-gallery-widget' ); ?></p>
					    	...
					    	<?php if ( '' === $username || '' === $access_token ) : ?>
					    		<a class="button button-large get-token" href="https://api.instagram.com/oauth/authorize/?client_id=63da809f6ee14dd194e92b415359aa47&scope=basic&redirect_uri=https://catchplugins.com/social-gallery-api?return_url=<?php echo esc_attr( $catch_instagram_feed_gallery_widget_page );?>&response_type=token&state=<?php echo esc_attr( $catch_instagram_feed_gallery_widget_page );?>"><?php esc_html_e( 'Get Access Token', 'catch-instagram-feed-gallery-widget' ) ?></a>
					...
					<div id="go-premium" class="content-wrapper col-2">
						...
						<div class="content">
							...
							<ul class="catchp-lists">
								<li><strong><?php esc_html_e( 'Social Gallery and Widget Shortcode Generator button in Post/Page', 'catch-instagram-feed-gallery-widget' ); ?>
								...
								<li><strong><?php esc_html_e( 'Link to image in social post', 'catch-instagram-feed-gallery-widget' ); ?></strong></li>
								...
								<li><strong><?php esc_html_e( 'Toggle link to social post', 'catch-instagram-feed-gallery-widget' ); ?></strong></li>
							</ul>

							<a href="https://catchplugins.com/plugins/catch-instagram-feed-gallery-widget-pro/" target="_blank"><?php esc_html_e( 'Find out why you should upgrade to Social Gallery and Widget Premium »', 'catch-instagram-feed-gallery-widget' ); ?></a>
						</div> <!-- .Content -->
					</div> <!-- #go-premium -->
				...
				<div id="features" class="wpcatchtab save">
					<div class="content-wrapper col-3">
						...
						<div class="content">
							...
							<a href="https://catchplugins.com/plugins/catch-instagram-feed-gallery-widget-pro/" target="_blank"><?php esc_html_e( 'Upgrade to Social Gallery and Widget Premium »', 'catch-instagram-feed-gallery-widget' ); ?></a>
						</div><!-- .content -->
					</div><!-- content-wrapper -->
				</div> <!-- Featured -->
				...
				<div id="premium-extensions" class="wpcatchtab  save">
					...
					<div class="about-text">
						<h2><?php esc_html_e( 'Get Social Gallery and Widget Pro -', 'catch-instagram-feed-gallery-widget' ); ?> <a href="https://catchplugins.com/plugins/catch-instagram-feed-gallery-widget-pro/" target="_blank"><?php esc_html_e( 'Get It Here!', 'catch-instagram-feed-gallery-widget' ); ?></a></h2>
						<p><?php esc_html_e( 'You are currently using the free version of Social Gallery and Widget.', 'catch-instagram-feed-gallery-widget' ); ?><br />
